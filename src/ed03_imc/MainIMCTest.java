/*
 * Clase para testear el programa para calcular el IMC de 2 personas
 * Se incluye en el paquete com.mycompany.imc
 */
package ed03_imc;

// Librería necesarias para qie la clase funcione
...
public class MainIMCTest {
    ...
    */
    ...
    @DisplayName("Test con muchos datos")
    @ParameterizedTest(name = "{index} => valor={0}, expResult={1}")
    @CsvFileSource(resources = "/ed03_imc/datos.csv")
